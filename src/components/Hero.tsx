      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 w-full pb-20">
        ...
        >
          ...
          <p className="text-gray-300 text-base md:text-lg mb-8 max-w-xl leading-relaxed">
            REAL BUILDER prepares workers, companies, and employers by transforming people with <span className="text-white font-semibold">basic experience</span> into skilled, <span className="text-white font-semibold">certified</span>, and fully equipped REAL BUILDERS ready for today's market.
          </p>
